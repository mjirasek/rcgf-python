...
# for i in range(100):
#     print(_Bznew(15.5,12,5,0,14,123,0,0,0))
...
def B(
    ...
    return (
        _Bx(a1,a2,b1,b2,c1,c2,x,y,z),
        (_By(a1,a2,b1,b2,c1,c2,1,x,y,z,J) - _By(a1,a2,b1,b2,c1,c2,0,x,y,z,J)),
        _Bz(a1,a2,b1,b2,c1,c2,x,y,z)
)
